        ...
        public static void AddCustomServices(this IServiceCollection app, IConfiguration configuration)
        {
            ...
            if (configuration.GetSection("TipoBanco").Value == "MYSQL")
            {
                ...
                app.AddDbContext<APIDbContext>(options =>
                    options.UseMySql(configuration.GetConnectionString("BancoDadosMySQL"), serverVersion,
                    mysqlOptions => mysqlOptions.EnableRetryOnFailure()));
            }
            else
            {
                app.AddDbContext<APIDbContext>(options =>
                    options.UseSqlServer(configuration.GetConnectionString("BancoDadosSQLServer"),
